...
public class AndroidAudioConverter {
    ...
    public AndroidAudioConverter setOutFile(File inFile) {
        this.outFile = inFile;
        return this;
    }
    ...
    public void convert() {
        ...
        final File convertedFile = getConvertedFile(outFile, format);
        //final String[] cmd = new String[]{"-y", "-i", audioFile.getPath(), convertedFile.getPath()};
        // Bitrate changer
       /* final String[] cmd2 = new String[]{"-i",
                audioFile.getPath(),
                "-ac",
                "1",
                "-ar",
      ...
      /*  // Sample rate changer
        final String[] cmd2 = new String[]{"-i",
                ...
                convertedFile.getPath()};*/
        try {
            FFmpeg.getInstance(context).execute(cmd2, new FFmpegExecuteResponseHandler() {
                @Override
                public void onStart() {
